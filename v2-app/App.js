...
export default function App(){
 ...
 if(screen==='benefits')return <Page><Back title="VANTAGENS"/>
  <View style={s.benefitIntro}>
   <View style={s.benefitIntroTop}><ShortcutIcon type="star"/><View style={s.benefitIntroText}><Text style={s.benefitIntroTitle}>REDE DE DESCONTOS SCU TORREENSE</Text><Text style={s.benefitIntroCount}>{benefits.length} parceiros disponíveis</Text></View></View>
