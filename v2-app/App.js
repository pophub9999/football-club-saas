...
const s=StyleSheet.create({
 ...
 calendarSectionTitle:{color:'#fff',fontSize:fs(7.2),fontWeight:'800',letterSpacing:.6,marginTop:10,marginBottom:6},calendarUpcomingCard:{flexDirection:'row',borderRadius:10,backgroundColor:'rgba(8,43,72,.86)',borderWidth:1,borderColor:'rgba(120,164,197,.25)',marginBottom:6,overflow:'hidden'},calendarUpcomingDate:{width:61,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(1,23,43,.55)',padding:7},calendarUpcomingDay:{color:'#fff',fontSize:fs(7),fontWeight:'800'},calendarUpcomingTime:{color:'#f1b94f',fontSize:fs(6.3),marginTop:2},calendarUpcomingBody:{flex:1,padding:7},calendarUpcomingCompetitionRow:{flexDirection:'row',alignItems:'center',marginBottom:4},calendarUpcomingCompetition:{color:'#8fa9bc',fontSize:fs(5.7)},calendarUpcomingTeams:{flexDirection:'row',alignItems:'center'},calendarUpcomingLogo:{width:22,height:24},calendarUpcomingTitle:{flex:1,color:'#fff',fontSize:fs(7.3),fontWeight:'700',textAlign:'center'},calendarUpcomingVenue:{color:'#7892a7',fontSize:fs(5.3),textAlign:'center',marginTop:4},
 calendarHistoryCard:{padding:8,borderRadius:9,backgroundColor:'rgba(8,43,72,.70)',borderWidth:1,borderColor:'rgba(120,164,197,.18)',marginBottom:5},calendarHistoryMeta:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:5},calendarHistoryMetaRight:{flexDirection:'row',alignItems:'center'},calendarHistoryDate:{color:'#f1b94f',fontSize:fs(5.6)},calendarHistoryCompetition:{color:'#7892a7',fontSize:fs(5.3)},calendarHistoryScoreRow:{flexDirection:'row',alignItems:'center'},calendarHistoryTeam:{width:'25%',color:'#fff',fontSize:fs(6.4),fontWeight:'600',textAlign:'right'},calendarHistoryLogo:{width:21,height:23,marginHorizontal:5},calendarHistoryScore:{width:48,color:'#fff',fontSize:fs(8.5),fontWeight:'800',textAlign:'center'},
 classificationFilterLabel:{color:'#8fa9bc',fontSize:fs(5.5),fontWeight:'700',letterSpacing:.65,marginBottom:5,marginTop:2},classificationFilterBar:{height:33,maxHeight:33,flexGrow:0,flexShrink:0,marginBottom:8},classificationCompetitionGrid:{flexDirection:'row',flexWrap:'wrap',marginBottom:8},classificationCompetitionChip:{minHeight:28,borderRadius:14,borderWidth:1,borderColor:'rgba(120,164,197,.38)',paddingHorizontal:10,paddingVertical:6,marginRight:5,marginBottom:5,justifyContent:'center'},classificationCompetitionChipText:{color:'#b8c8d8',fontSize:fs(5.7),fontWeight:'700'},classificationCompetitionTitle:{color:'#fff',fontSize:fs(8.2),fontWeight:'800',letterSpacing:.25,marginBottom:7,marginTop:1},
 classificationRouteCard:{borderRadius:10,overflow:'hidden',borderWidth:1,borderColor:'rgba(120,164,197,.24)',backgroundColor:'rgba(8,43,72,.68)'},classificationRouteTitle:{color:'#f1b94f',fontSize:fs(6.2),fontWeight:'800',letterSpacing:.5,padding:8,borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.07)'},classificationRouteMatch:{padding:7,borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.06)'},classificationRouteMeta:{flexDirection:'row',justifyContent:'space-between',marginBottom:5},classificationRouteDate:{color:'#9fb5c7',fontSize:fs(5.5)},classificationRouteRound:{color:'#7892a7',fontSize:fs(5.3)},classificationRouteTeams:{flexDirection:'row',alignItems:'center'},classificationRouteLogo:{width:20,height:22},classificationRouteTeam:{flex:1,color:'#fff',fontSize:fs(6.2),fontWeight:'600',marginHorizontal:4},classificationRouteScore:{width:42,color:'#fff',fontSize:fs(7.7),fontWeight:'800',textAlign:'center'},
 standingsCard:{borderRadius:10,overflow:'hidden',borderWidth:1,borderColor:'rgba(120,164,197,.24)'},standingsHead:{height:28,flexDirection:'row',alignItems:'center',backgroundColor:'rgba(1,23,43,.72)',paddingHorizontal:6},standingsRow:{minHeight:34,flexDirection:'row',alignItems:'center',backgroundColor:'rgba(8,43,72,.78)',borderTopWidth:1,borderTopColor:'rgba(255,255,255,.06)',paddingHorizontal:6},standingsRowClub:{backgroundColor:'rgba(241,185,79,.11)'},standingsCell:{width:28,color:'#a9bdcd',fontSize:fs(6.2),textAlign:'center'},standingsPos:{width:23},standingsTeam:{flex:1,textAlign:'left'},standingsPts:{color:'#fff',fontWeight:'800'},standingsTeamWrap:{flex:1,flexDirection:'row',alignItems:'center'},standingsLogo:{width:22,height:24,marginRight:6},standingsTeamName:{flex:1,color:'#fff',fontSize:fs(6.6),fontWeight:'600'},
 statsHero:{flexDirection:'row',alignItems:'center',padding:11,borderRadius:11,backgroundColor:'rgba(8,43,72,.88)',borderWidth:1,borderColor:'rgba(241,185,79,.30)',marginBottom:8},statsHeroPosition:{color:'#f1b94f',fontSize:fs(18),fontWeight:'900',marginRight:11},statsHeroTitle:{color:'#fff',fontSize:fs(8.2),fontWeight:'800'},statsHeroSub:{color:'#8fa9bc',fontSize:fs(5.7),marginTop:2},statsHeroPoints:{marginLeft:'auto',color:'#fff',fontSize:fs(9),fontWeight:'800'},statsGrid:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between'},statsBox:{width:'32%',paddingVertical:9,alignItems:'center',borderRadius:9,backgroundColor:'rgba(8,43,72,.82)',borderWidth:1,borderColor:'rgba(120,164,197,.22)',marginBottom:6},statsValue:{color:'#fff',fontSize:fs(13),fontWeight:'900'},statsLabel:{color:'#8fa9bc',fontSize:fs(5.2),marginTop:2},statsWide:{flexDirection:'row',justifyContent:'space-around',padding:10,borderRadius:9,backgroundColor:'rgba(1,23,43,.55)',marginTop:2},statsWideLabel:{color:'#8fa9bc',fontSize:fs(5.4),textAlign:'center'},statsWideValue:{color:'#f1b94f',fontSize:fs(10),fontWeight:'800',textAlign:'center',marginTop:2},formRow:{flexDirection:'row'},formBadge:{width:28,height:28,borderRadius:14,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(120,164,197,.30)',marginRight:6},formWin:{backgroundColor:'rgba(53,160,95,.75)'},formDraw:{backgroundColor:'rgba(204,151,38,.75)'},formLoss:{backgroundColor:'rgba(180,52,67,.75)'},formBadgeText:{color:'#fff',fontSize:fs(7),fontWeight:'800'},
  squadGroupCard:{borderRadius:10,backgroundColor:'rgba(8,43,72,.86)',borderWidth:1,borderColor:'rgba(120,164,197,.22)',marginBottom:9,overflow:'hidden'},squadGroupTitle:{color:'#fff',fontSize:fs(8.8),fontWeight:'800',paddingHorizontal:10,paddingVertical:9,borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.07)'},squadPlayerRow:{minHeight:47,flexDirection:'row',alignItems:'center',paddingHorizontal:8,borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.06)'},squadThumbWrap:{width:38,height:42,overflow:'hidden',borderRadius:7,backgroundColor:'rgba(255,255,255,.05)'},squadRowNumber:{width:34,color:'#f1b94f',fontSize:fs(9),fontWeight:'800',textAlign:'center'},squadRowBody:{flex:1},squadRowName:{color:'#fff',fontSize:fs(7.4),fontWeight:'600'},squadRowArrow:{color:'#7892a7',fontSize:fs(16),marginLeft:4},
  playerDetailPage:{paddingBottom:16},playerDetailHero:{height:280,borderRadius:13,overflow:'hidden',backgroundColor:'#f4f4f4',alignItems:'center',justifyContent:'flex-end'},playerDetailPhoto:{width:'100%',height:'100%'},playerDetailHeader:{paddingTop:10},playerDetailName:{color:'#fff',fontSize:fs(12),fontWeight:'900'},playerDetailNumber:{color:'#f1b94f'},playerDetailBirth:{color:'#b9cad8',fontSize:fs(7),marginTop:3},playerDetailFacts:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between',marginTop:12,marginBottom:6},playerDetailFact:{width:'48.5%',minHeight:60,borderRadius:9,backgroundColor:'rgba(8,43,72,.82)',borderWidth:1,borderColor:'rgba(120,164,197,.22)',padding:8,marginBottom:6},playerDetailFactLabel:{color:'#7892a7',fontSize:fs(5.1),fontWeight:'700',letterSpacing:.35},playerDetailFactValue:{color:'#fff',fontSize:fs(7.2),fontWeight:'700',marginTop:8},playerBirthPlaceCard:{borderRadius:9,backgroundColor:'rgba(8,43,72,.82)',borderWidth:1,borderColor:'rgba(120,164,197,.22)',padding:8,marginBottom:12},playerBirthPlaceValue:{color:'#fff',fontSize:fs(7.1),fontWeight:'600',marginTop:6},playerDetailTabs:{flexDirection:'row',borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.12)',marginBottom:10},playerDetailTab:{height:31,justifyContent:'center',marginRight:18,borderBottomWidth:2,borderBottomColor:'transparent'},playerDetailTabOn:{borderBottomColor:'#f1b94f'},playerDetailTabText:{color:'#879dad',fontSize:fs(6.4),fontWeight:'700',letterSpacing:.35},playerDetailTabTextOn:{color:'#fff'},playerDetailSectionTitle:{color:'#fff',fontSize:fs(8.3),fontWeight:'800',marginBottom:8},playerDetailStatGrid:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between'},playerDetailStat:{width:'48.5%',minHeight:72,borderRadius:10,borderWidth:1,borderColor:'rgba(120,164,197,.22)',backgroundColor:'rgba(8,43,72,.78)',padding:10,marginBottom:6},playerDetailStatLabel:{color:'#b8c8d8',fontSize:fs(6.2),fontWeight:'700'},playerDetailStatValue:{color:'#fff',fontSize:fs(17),fontWeight:'900',marginTop:7},playerDetailInfoStrip:{flexDirection:'row',justifyContent:'space-between',marginTop:2},playerDetailInfoItem:{width:'48.5%',borderRadius:9,borderWidth:1,borderColor:'rgba(241,185,79,.24)',backgroundColor:'rgba(241,185,79,.07)',padding:9},playerDetailInfoValue:{color:'#f1b94f',fontSize:fs(7.4),fontWeight:'800',marginTop:6},playerDetailNote:{color:'#8fa9bc',fontSize:fs(5.8),lineHeight:fs(8.5),marginTop:8},playerDetailTextCard:{borderRadius:10,borderWidth:1,borderColor:'rgba(120,164,197,.22)',backgroundColor:'rgba(8,43,72,.78)',padding:11},playerDetailText:{color:'#d7e2ea',fontSize:fs(6.7),lineHeight:fs(10)},playerDetailCareerCard:{marginTop:8,borderRadius:10,borderWidth:1,borderColor:'rgba(120,164,197,.22)',backgroundColor:'rgba(8,43,72,.78)',padding:10},playerDetailCareerTitle:{color:'#f1b94f',fontSize:fs(6.2),fontWeight:'800',letterSpacing:.5,marginBottom:5},playerDetailCareerRow:{flexDirection:'row',justifyContent:'space-between',paddingVertical:5,borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.05)'},playerDetailCareerLabel:{color:'#8fa9bc',fontSize:fs(6)},playerDetailCareerValue:{color:'#fff',fontSize:fs(6.2),fontWeight:'700',textAlign:'right'},playerTrophyRow:{minHeight:38,flexDirection:'row',alignItems:'center',borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.06)'},playerTrophyIcon:{width:26,height:26,borderRadius:13,backgroundColor:'rgba(241,185,79,.13)',alignItems:'center',justifyContent:'center',marginRight:8},playerTrophyIconText:{color:'#f1b94f',fontSize:fs(9)},playerTrophyText:{flex:1,color:'#fff',fontSize:fs(6.8),fontWeight:'600'},
  squadTopButton:{height:34,marginBottom:10,borderRadius:10,borderWidth:1,borderColor:'rgba(241,185,79,.55)',backgroundColor:'rgba(8,43,72,.82)',flexDirection:'row',alignItems:'center',paddingHorizontal:11},squadTopButtonText:{color:'#fff',fontSize:fs(7.5),letterSpacing:.6,marginLeft:9,flex:1},squadTopArrow:{color:'#f1b94f',fontSize:fs(18)},playerGrid:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between'},playerCard:{width:'48.5%',marginBottom:8,borderRadius:10,backgroundColor:'rgba(8,43,72,.86)',borderWidth:1,borderColor:'rgba(120,164,197,.25)',padding:7,position:'relative'},playerPhoto:{width:'100%',aspectRatio:.86,borderRadius:8,backgroundColor:'rgba(255,255,255,.05)'},playerPhotoDetail:{width:'100%',height:'100%',backgroundColor:'#f4f4f4'},playerPhotoCompact:{width:'100%',height:'100%',borderRadius:7,backgroundColor:'rgba(255,255,255,.05)'},playerPhotoFallback:{alignItems:'center',justifyContent:'center'},playerPhotoLogo:{width:52,height:64},playerPhotoLogoCompact:{width:24,height:29},playerNumberBadge:{position:'absolute',top:12,right:12,minWidth:22,height:22,borderRadius:11,backgroundColor:'#f1b94f',alignItems:'center',justifyContent:'center'},playerNumber:{color:'#082b48',fontSize:fs(7),fontWeight:'700'},playerName:{color:'#fff',fontSize:fs(7.4),lineHeight:fs(10),marginTop:6,fontWeight:'600'},playerPosition:{color:'#f1b94f',fontSize:fs(6.2),marginTop:2},playerMeta:{color:'#9fb5c7',fontSize:fs(5.8),marginTop:2},filters:{marginBottom:12},filtersContent:{paddingRight:24},filter:{height:27,paddingHorizontal:10,marginRight:6,borderRadius:14,borderWidth:1,borderColor:'rgba(120,164,197,.35)',justifyContent:'center',backgroundColor:'rgba(8,43,72,.72)'},filterOn:{borderColor:'#f1b94f',backgroundColor:'rgba(241,185,79,.12)'},filterText:{color:'#b7c9d9',fontSize:fs(6.5)},filterTextOn:{color:'#f1b94f'},gameTabs:{flexDirection:'row',marginTop:10,marginBottom:8,borderRadius:10,backgroundColor:'rgba(4,28,51,.60)',padding:3},gameTab:{flex:1,height:29,alignItems:'center',justifyContent:'center',borderRadius:8},gameTabOn:{backgroundColor:'rgba(241,185,79,.14)',borderWidth:1,borderColor:'#f1b94f'},gameTabText:{color:'#aebfce',fontSize:fs(7),letterSpacing:.3},gameTabTextOn:{color:'#f1b94f'},timeline:{marginTop:10,paddingTop:8,borderTopWidth:1,borderTopColor:'rgba(255,255,255,.08)'},sourceButton:{marginTop:16,height:32,borderRadius:8,borderWidth:1,borderColor:'#f1b94f',alignItems:'center',justifyContent:'center'},sourceButtonText:{color:'#f1b94f',fontSize:fs(7),letterSpacing:.4},eventCard:{flexDirection:'row',marginBottom:7,borderRadius:10,backgroundColor:'rgba(8,43,72,.84)',borderWidth:1,borderColor:'rgba(120,164,197,.25)',overflow:'hidden'},dateBox:{width:72,padding:9,justifyContent:'center',backgroundColor:'rgba(4,28,51,.55)'},dateBoxText:{color:'#fff',fontSize:fs(8)},eventType:{color:'#f1b94f',fontSize:fs(5.8),marginTop:4},eventBody:{flex:1,padding:9},eventSport:{color:'#9eb6c9',fontSize:fs(6)},eventTitle:{color:'#fff',fontSize:fs(8.5),marginVertical:3}
});