...
const HEADER_BG='https://upload.wikimedia.org/wikipedia/commons/6/68/Castelo_de_Torres_Vedras_-_Portugal_%288704876877%29.jpg';
const NEWS_IMG=[
...
function Header({onLogin}){
 return <ImageBackground source={{uri:HEADER_BG}} style={s.headerBg} imageStyle={s.headerBgImg}>
   <View style={s.headerDark}/><View style={s.headerBlue}/><View style={s.headerWine}/><View style={s.headerBlend}/>
   <View style={s.header}>
     <Crest size={90}/>
...
function MatchCard({go}){
 return <View style={s.matchCard}><View pointerEvents="none" style={s.cardGlow}/>
...
const s=StyleSheet.create({
 ...
 phone:{flex:1,width:'100%',maxWidth:512,backgroundColor:'#031827',overflow:'hidden',borderRadius:34,borderWidth:1,borderColor:'#5b7186'},
 scroll:{flex:1},
 homeContent:{paddingBottom:92,backgroundColor:'#031827'},
 headerBg:{height:194,justifyContent:'center',overflow:'hidden',backgroundColor:'#061726'},headerBgImg:{opacity:.54},
 headerDark:{position:'absolute',left:0,right:0,top:0,bottom:0,backgroundColor:'rgba(1,12,24,.44)'},
 headerBlue:{position:'absolute',left:0,top:0,bottom:0,width:'72%',backgroundColor:'rgba(0,31,66,.74)'},
 headerWine:{position:'absolute',right:0,top:0,bottom:0,width:'60%',backgroundColor:'rgba(112,12,43,.58)'},
 headerBlend:{position:'absolute',left:'37%',right:'35%',top:0,bottom:0,backgroundColor:'rgba(45,13,48,.18)'},
 header:{paddingHorizontal:26,flexDirection:'row',alignItems:'center',gap:15,paddingTop:4},
 ...
 matchCard:{backgroundColor:'#0a2945',borderRadius:22,borderWidth:1,borderColor:'#365b78',padding:19,shadowColor:'#000',shadowOpacity:.42,shadowRadius:20,elevation:8,overflow:'hidden'},cardGlow:{position:'absolute',left:0,right:0,top:0,height:'48%',backgroundColor:'rgba(43,89,124,.11)'},
 ...
 shortcuts:{flexDirection:'row',gap:8,marginTop:13},shortcut:{flex:1,height:82,borderRadius:14,backgroundColor:'#0b2a46',borderWidth:1,borderColor:'#31516d',alignItems:'center',justifyContent:'center',shadowColor:'#000',shadowOpacity:.24,shadowRadius:10,elevation:3},shortcutIcon:{color:C.gold,fontSize:22},shortcutLabel:{color:'#fff',fontWeight:'800',fontSize:7.3,marginTop:7,textAlign:'center'},
 ...
 sideCol:{flex:1,gap:8},sideCard:{flex:1,minHeight:114,flexDirection:'row',alignItems:'center',gap:8,backgroundColor:'#0a2945',borderRadius:14,borderWidth:1,borderColor:'#31516d',padding:8},thumb:{width:58,height:78,borderRadius:9,backgroundColor:'#112f47'},sideText:{flex:1},sideTitle:{color:'#fff',fontWeight:'900',fontSize:10.4,lineHeight:14,marginTop:5},sideArrow:{color:'#b8c6d2',fontSize:22},
