...
const s=StyleSheet.create({
 root:{flex:1,backgroundColor:Platform.OS==='web'?'#00142c':'#063457',alignItems:'center',justifyContent:'center',overflow:'hidden'},background:{width:'100%',height:'100%',opacity:Platform.OS==='web'?1:.94},mobileLightWash:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(78,145,190,.11)'},
 ...
 memberFees:{borderRadius:10,overflow:'hidden',borderWidth:1,borderColor:'rgba(120,164,197,.24)',marginBottom:8},memberFeeRow:{minHeight:32,flexDirection:'row',alignItems:'center',paddingHorizontal:8,borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.07)',backgroundColor:Platform.OS==='web'?'rgba(8,43,72,.76)':'rgba(24,66,99,.76)'},memberFeeMain:{flex:1},memberFeeName:{color:'#fff',fontSize:fs(6.7),fontWeight:'600'},memberFeeAge:{color:Platform.OS==='web'?'#8fa9bc':'#b6c9d7',fontSize:fs(5.4),marginTop:1},memberFeeValue:{width:58,color:'#f1b94f',fontSize:fs(6.1),textAlign:'right'},memberFeeAnnual:{width:58,color:Platform.OS==='web'?'#b8c8d8':'#d2dde5',fontSize:fs(5.8),textAlign:'right'},
 ...
 calendarSectionTitle:{color:'#fff',fontSize:fs(7.2),fontWeight:'800',letterSpacing:.6,marginTop:10,marginBottom:6},calendarUpcomingCard:{flexDirection:'row',borderRadius:10,backgroundColor:Platform.OS==='web'?'rgba(8,43,72,.86)':'rgba(24,66,99,.86)',borderWidth:1,borderColor:'rgba(120,164,197,.25)',marginBottom:6,overflow:'hidden'},calendarUpcomingDate:{width:61,alignItems:'center',justifyContent:'center',backgroundColor:Platform.OS==='web'?'rgba(1,23,43,.55)':'rgba(14,48,76,.55)',padding:7},calendarUpcomingDay:{color:'#fff',fontSize:fs(7),fontWeight:'800'},calendarUpcomingTime:{color:'#f1b94f',fontSize:fs(6.3),marginTop:2},calendarUpcomingBody:{flex:1,padding:7},calendarUpcomingCompetitionRow:{flexDirection:'row',alignItems:'center',marginBottom:4},calendarUpcomingCompetition:{color:Platform.OS==='web'?'#8fa9bc':'#b6c9d7',fontSize:fs(5.7)},calendarUpcomingTeams:{flexDirection:'row',alignItems:'center'},calendarUpcomingLogo:{width:22,height:24},calendarUpcomingTitle:{flex:1,color:'#fff',fontSize:fs(7.3),fontWeight:'700',textAlign:'center'},calendarUpcomingVenue:{color:Platform.OS==='web'?'#7892a7':'#a8bfd0',fontSize:fs(5.3),textAlign:'center',marginTop:4},
