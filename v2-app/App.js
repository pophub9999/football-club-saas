...
export default function App(){
 ...
 const [benefits,setBenefits]=useState([]),[benefitCategory,setBenefitCategory]=useState('TODAS'),[benefitSearch,setBenefitSearch]=useState('');
 ...
 if(screen==='benefits')return <Page><Back title="VANTAGENS"/>
  <View style={s.benefitIntro}>
   <View style={s.benefitIntroTop}><ShortcutIcon type="star"/><View style={s.benefitIntroText}><Text style={s.benefitIntroTitle}>REDE DE VANTAGENS SCU TORREENSE</Text><Text style={s.benefitIntroCount}>{benefits.length} vantagens e parcerias disponíveis</Text></View></View>
   <Text style={s.benefitIntroBody}>Procura o parceiro ou escolhe uma categoria. Confirma sempre as condições do desconto antes da compra.</Text>
  </View>
  <TextInput value={benefitSearch} onChangeText={setBenefitSearch} placeholder="Pesquisar parceiro, localidade ou benefício..." placeholderTextColor="#7892a7" style={s.benefitSearch}/>
  ...
  {filteredBenefits.length?filteredBenefits.map(b=><View key={b.id} style={s.benefitCard}>
...
const s=StyleSheet.create({
 ...
 benefitIntro:{padding:10,borderRadius:12,backgroundColor:'rgba(8,43,72,.90)',borderWidth:1,borderColor:'rgba(241,185,79,.30)',marginBottom:9},benefitIntroTop:{flexDirection:'row',alignItems:'center'},benefitIntroText:{marginLeft:9,flex:1},benefitIntroTitle:{color:'#fff',fontSize:8.4,letterSpacing:.45},benefitIntroCount:{color:'#f1b94f',fontSize:7.2,marginTop:2},benefitIntroBody:{color:'#a9bdcd',fontSize:6.4,lineHeight:9.5,marginTop:7},benefitSearch:{height:34,borderRadius:9,borderWidth:1,borderColor:'rgba(120,164,197,.34)',backgroundColor:'rgba(1,23,43,.62)',color:'#fff',fontSize:7.2,paddingHorizontal:10,marginBottom:9},benefitResultHead:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:-3,marginBottom:7},benefitResultCount:{color:'#9fb5c7',fontSize:6.3,letterSpacing:.35},benefitSource:{color:'#f1b94f',fontSize:6.1,letterSpacing:.25},benefitCard:{padding:10,marginBottom:7,borderRadius:11,backgroundColor:'rgba(8,43,72,.88)',borderWidth:1,borderColor:'rgba(120,164,197,.25)'},benefitCardTop:{flexDirection:'row',alignItems:'flex-start'},benefitNameWrap:{flex:1,paddingRight:8},benefitName:{color:'#fff',fontSize:9,lineHeight:12,fontWeight:'600'},benefitCategory:{color:'#8fa9bc',fontSize:5.9,lineHeight:8,marginTop:2},benefitDiscount:{minWidth:44,height:28,paddingHorizontal:7,borderRadius:8,backgroundColor:'#f1b94f',alignItems:'center',justifyContent:'center'},benefitDiscountText:{color:'#082b48',fontSize:8.3,fontWeight:'800'},benefitConditions:{color:'#d7e1e9',fontSize:6.7,lineHeight:10,marginTop:7},benefitAddress:{color:'#91aabd',fontSize:6.1,lineHeight:9,marginTop:6},benefitMapBtn:{height:28,borderRadius:7,borderWidth:1,borderColor:'rgba(241,185,79,.43)',marginTop:8,paddingHorizontal:9,flexDirection:'row',alignItems:'center'},benefitMapText:{color:'#f1b94f',fontSize:6.2,letterSpacing:.35,flex:1},benefitMapArrow:{color:'#f1b94f',fontSize:16},
