...
const s=StyleSheet.create({
 root:{flex:1,backgroundColor:Platform.OS==='web'?'#00142c':'#0d5782',alignItems:'center',justifyContent:'center',overflow:'hidden'},background:{width:'100%',height:'100%',opacity:Platform.OS==='web'?1:.88},mobileLightWash:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(126,190,226,.20)'},
