...
const s=StyleSheet.create({
 ...
 youtubeBadge:{alignSelf:'center',minHeight:18,flexDirection:'row',alignItems:'center',paddingHorizontal:6,borderRadius:9,backgroundColor:'rgba(255,255,255,.08)',borderWidth:1,borderColor:'rgba(255,255,255,.16)'},youtubeBadgeLight:{backgroundColor:'rgba(255,255,255,.92)',borderColor:'rgba(0,0,0,.08)'},youtubeIcon:{width:17,height:12,borderRadius:3,backgroundColor:'#ff0033',alignItems:'center',justifyContent:'center',marginRight:4},youtubePlay:{color:'#fff',fontSize:5.3,lineHeight:7,fontWeight:'900',marginLeft:1},youtubeBadgeText:{color:'#fff',fontSize:4.8,fontWeight:'800',letterSpacing:.25},youtubeBadgeTextLight:{color:'#17212a'},youtubeCenter:{alignItems:'center',marginTop:5},youtubeHistory:{alignItems:'flex-end',marginTop:4},youtubeInline:{alignItems:'flex-start',marginTop:4},
