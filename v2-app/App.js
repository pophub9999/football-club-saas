...
function TeamLogo({name,uri,style}){
 const finalUri=uri||(/^SCU Torreense/i.test(name||'')?LOGO_URL:null);
...
function YouTubeBadge({onPress}){
 return <Pressable accessibilityRole="button" accessibilityLabel="Abrir no SCUTV" hitSlop={7} onPress={e=>{e?.stopPropagation?.();onPress?.()}} style={s.youtubeBadge}>
   ...
   <ScrollView ref={calendarScrollRef} style={s.calendarTimeline} showsVerticalScrollIndicator={false} contentContainerStyle={s.calendarTimelineContent}>
    {calendarLoading?<ActivityIndicator/>:<>
     {olderCalendarMatches.length?olderCalendarMatches.map(x=><Pressable key={x.id} style={s.calendarHistoryCard} onPress={()=>openCalendarGame(x)}>
      <View style={s.calendarHistoryMeta}><Text style={s.calendarHistoryDate}>{x.date}</Text><View style={s.calendarHistoryMetaRight}><Text style={s.calendarHistoryCompetition}>{x.competition}{x.round?' · '+x.round:''}</Text>{x.scutvVideo?<YouTubeBadge onPress={()=>openScutv(x.scutvVideo)}/>:null}</View></View>
     ...
     <View onLayout={e=>{
      ...
      {lastCalendarMatch?<Pressable style={s.calendarLastCard} onPress={()=>openCalendarGame(lastCalendarMatch)}>
       <View style={s.calendarCompetitionInline}><Text style={s.calendarCardCompetition}>{lastCalendarMatch.competition}{lastCalendarMatch.round?' · '+lastCalendarMatch.round:''}</Text>{lastCalendarMatch.scutvVideo?<YouTubeBadge onPress={()=>openScutv(lastCalendarMatch.scutvVideo)}/>:null}</View>
...
const s=StyleSheet.create({
 ...
 calendarLastCard:{padding:9,borderRadius:10,backgroundColor:'rgba(255,255,255,.96)',marginBottom:8},calendarCompetitionInline:{flexDirection:'row',alignItems:'center',justifyContent:'center',marginBottom:5},calendarCardCompetition:{color:'#7e8790',fontSize:6.1,fontWeight:'700',textAlign:'center'},calendarLastRow:{flexDirection:'row',alignItems:'center',justifyContent:'center'},calendarLastTeam:{width:'34%',flexDirection:'row',alignItems:'center',justifyContent:'flex-end'},calendarLastTeamName:{color:'#6f7880',fontSize:7.5,fontWeight:'700',textAlign:'right',flexShrink:1},calendarLastLogo:{width:28,height:32,marginHorizontal:5},calendarLastScoreBox:{width:'25%',alignItems:'center'},calendarLastScore:{color:'#313a42',fontSize:13,fontWeight:'800'},calendarLastDate:{color:'#7e8790',fontSize:6.2,fontWeight:'700',marginTop:1},
 calendarNextCard:{padding:12,borderRadius:12,backgroundColor:'rgba(255,255,255,.98)',marginBottom:10},calendarNextCompetitionRow:{flexDirection:'row',alignItems:'center',justifyContent:'center',marginBottom:10},calendarNextCompetition:{color:'#17212a',fontSize:8.3,fontWeight:'800',textAlign:'center'},calendarNextTeams:{flexDirection:'row',alignItems:'center',justifyContent:'space-between'},calendarNextTeam:{width:'27%',alignItems:'center'},calendarNextLogo:{width:58,height:64},calendarNextTeamCode:{color:'#17212a',fontSize:7.5,fontWeight:'800',marginTop:4},calendarNextCenter:{width:'40%',alignItems:'center'},calendarNextDate:{color:'#111',fontSize:14,fontWeight:'900'},calendarNextTime:{color:'#111',fontSize:8,fontWeight:'700',marginTop:1},calendarNextVenue:{color:'#4b545b',fontSize:5.7,lineHeight:8,textAlign:'center',marginTop:3},calendarNextMatchup:{color:'#111',fontSize:16,lineHeight:19,fontWeight:'900',textAlign:'center',marginTop:12},
 calendarSectionTitle:{color:'#fff',fontSize:7.2,fontWeight:'800',letterSpacing:.6,marginTop:10,marginBottom:6},calendarUpcomingCard:{flexDirection:'row',borderRadius:10,backgroundColor:'rgba(8,43,72,.86)',borderWidth:1,borderColor:'rgba(120,164,197,.25)',marginBottom:6,overflow:'hidden'},calendarUpcomingDate:{width:61,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(1,23,43,.55)',padding:7},calendarUpcomingDay:{color:'#fff',fontSize:7,fontWeight:'800'},calendarUpcomingTime:{color:'#f1b94f',fontSize:6.3,marginTop:2},calendarUpcomingBody:{flex:1,padding:7},calendarUpcomingCompetitionRow:{flexDirection:'row',alignItems:'center',marginBottom:4},calendarUpcomingCompetition:{color:'#8fa9bc',fontSize:5.7},calendarUpcomingTeams:{flexDirection:'row',alignItems:'center'},calendarUpcomingLogo:{width:22,height:24},calendarUpcomingTitle:{flex:1,color:'#fff',fontSize:7.3,fontWeight:'700',textAlign:'center'},calendarUpcomingVenue:{color:'#7892a7',fontSize:5.3,textAlign:'center',marginTop:4},
 calendarHistoryCard:{padding:8,borderRadius:9,backgroundColor:'rgba(8,43,72,.70)',borderWidth:1,borderColor:'rgba(120,164,197,.18)',marginBottom:5},calendarHistoryMeta:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:5},calendarHistoryMetaRight:{flexDirection:'row',alignItems:'center'},calendarHistoryDate:{color:'#f1b94f',fontSize:5.6},calendarHistoryCompetition:{color:'#7892a7',fontSize:5.3},calendarHistoryScoreRow:{flexDirection:'row',alignItems:'center'},calendarHistoryTeam:{width:'25%',color:'#fff',fontSize:6.4,fontWeight:'600',textAlign:'right'},calendarHistoryLogo:{width:21,height:23,marginHorizontal:5},calendarHistoryScore:{width:48,color:'#fff',fontSize:8.5,fontWeight:'800',textAlign:'center'},
 classificationFilterLabel:{color:'#8fa9bc',fontSize:5.5,fontWeight:'700',letterSpacing:.65,marginBottom:5,marginTop:2},classificationFilterBar:{height:33,maxHeight:33,flexGrow:0,flexShrink:0,marginBottom:8},classificationCompetitionGrid:{flexDirection:'row',flexWrap:'wrap',marginBottom:8},classificationCompetitionChip:{minHeight:28,borderRadius:14,borderWidth:1,borderColor:'rgba(120,164,197,.38)',paddingHorizontal:10,paddingVertical:6,marginRight:5,marginBottom:5,justifyContent:'center'},classificationCompetitionChipText:{color:'#b8c8d8',fontSize:5.7,fontWeight:'700'},classificationCompetitionTitle:{color:'#fff',fontSize:8.2,fontWeight:'800',letterSpacing:.25,marginBottom:7,marginTop:1},
 ...
 statsHero:{flexDirection:'row',alignItems:'center',padding:11,borderRadius:11,backgroundColor:'rgba(8,43,72,.88)',borderWidth:1,borderColor:'rgba(241,185,79,.30)',marginBottom:8},statsHeroPosition:{color:'#f1b94f',fontSize:18,fontWeight:'900',marginRight:11},statsHeroTitle:{color:'#fff',fontSize:8.2,fontWeight:'800'},statsHeroSub:{color:'#8fa9bc',fontSize:5.7,marginTop:2},statsHeroPoints:{marginLeft:'auto',color:'#fff',fontSize:9,fontWeight:'800'},statsGrid:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between'},statsBox:{width:'32%',paddingVertical:9,alignItems:'center',borderRadius:9,backgroundColor:'rgba(8,43,72,.82)',borderWidth:1,borderColor:'rgba(120,164,197,.22)',marginBottom:6},statsValue:{color:'#fff',fontSize:13,fontWeight:'900'},statsLabel:{color:'#8fa9bc',fontSize:5.2,marginTop:2},statsWide:{flexDirection:'row',justifyContent:'space-around',padding:10,borderRadius:9,backgroundColor:'rgba(1,23,43,.55)',marginTop:2},statsWideLabel:{color:'#8fa9bc',fontSize:5.4,textAlign:'center'},statsWideValue:{color:'#f1b94f',fontSize:10,fontWeight:'800',textAlign:'center',marginTop:2},formRow:{flexDirection:'row'},formBadge:{width:28,height:28,borderRadius:14,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(120,164,197,.30)',marginRight:6},formWin:{backgroundColor:'rgba(53,160,95,.75)'},formDraw:{backgroundColor:'rgba(204,151,38,.75)'},formLoss:{backgroundColor:'rgba(180,52,67,.75)'},formBadgeText:{color:'#fff',fontSize:7,fontWeight:'800'},
  ...
  playerDetailPage:{paddingBottom:16},playerDetailHero:{height:280,borderRadius:13,overflow:'hidden',backgroundColor:'#f4f4f4',alignItems:'center',justifyContent:'flex-end'},playerDetailPhoto:{width:'100%',height:'100%'},playerDetailHeader:{paddingTop:10},playerDetailName:{color:'#fff',fontSize:12,fontWeight:'900'},playerDetailNumber:{color:'#f1b94f'},playerDetailBirth:{color:'#b9cad8',fontSize:7,marginTop:3},playerDetailFacts:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between',marginTop:12,marginBottom:6},playerDetailFact:{width:'48.5%',minHeight:60,borderRadius:9,backgroundColor:'rgba(8,43,72,.82)',borderWidth:1,borderColor:'rgba(120,164,197,.22)',padding:8,marginBottom:6},playerDetailFactLabel:{color:'#7892a7',fontSize:5.1,fontWeight:'700',letterSpacing:.35},playerDetailFactValue:{color:'#fff',fontSize:7.2,fontWeight:'700',marginTop:8},playerBirthPlaceCard:{borderRadius:9,backgroundColor:'rgba(8,43,72,.82)',borderWidth:1,borderColor:'rgba(120,164,197,.22)',padding:8,marginBottom:12},playerBirthPlaceValue:{color:'#fff',fontSize:7.1,fontWeight:'600',marginTop:6},playerDetailTabs:{flexDirection:'row',borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.12)',marginBottom:10},playerDetailTab:{height:31,justifyContent:'center',marginRight:18,borderBottomWidth:2,borderBottomColor:'transparent'},playerDetailTabOn:{borderBottomColor:'#f1b94f'},playerDetailTabText:{color:'#879dad',fontSize:6.4,fontWeight:'700',letterSpacing:.35},playerDetailTabTextOn:{color:'#fff'},playerDetailSectionTitle:{color:'#fff',fontSize:8.3,fontWeight:'800',marginBottom:8},playerDetailStatGrid:{flexDirection:'row',flexWrap:'wrap',justifyContent:'space-between'},playerDetailStat:{width:'48.5%',minHeight:72,borderRadius:10,borderWidth:1,borderColor:'rgba(120,164,197,.22)',backgroundColor:'rgba(8,43,72,.78)',padding:10,marginBottom:6},playerDetailStatLabel:{color:'#b8c8d8',fontSize:6.2,fontWeight:'700'},playerDetailStatValue:{color:'#fff',fontSize:17,fontWeight:'900',marginTop:7},playerDetailInfoStrip:{flexDirection:'row',justifyContent:'space-between',marginTop:2},playerDetailInfoItem:{width:'48.5%',borderRadius:9,borderWidth:1,borderColor:'rgba(241,185,79,.24)',backgroundColor:'rgba(241,185,79,.07)',padding:9},playerDetailInfoValue:{color:'#f1b94f',fontSize:7.4,fontWeight:'800',marginTop:6},playerDetailNote:{color:'#8fa9bc',fontSize:5.8,lineHeight:8.5,marginTop:8},playerDetailTextCard:{borderRadius:10,borderWidth:1,borderColor:'rgba(120,164,197,.22)',backgroundColor:'rgba(8,43,72,.78)',padding:11},playerDetailText:{color:'#d7e2ea',fontSize:6.7,lineHeight:10},playerDetailCareerCard:{marginTop:8,borderRadius:10,borderWidth:1,borderColor:'rgba(120,164,197,.22)',backgroundColor:'rgba(8,43,72,.78)',padding:10},playerDetailCareerTitle:{color:'#f1b94f',fontSize:6.2,fontWeight:'800',letterSpacing:.5,marginBottom:5},playerDetailCareerRow:{flexDirection:'row',justifyContent:'space-between',paddingVertical:5,borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.05)'},playerDetailCareerLabel:{color:'#8fa9bc',fontSize:6},playerDetailCareerValue:{color:'#fff',fontSize:6.2,fontWeight:'700',textAlign:'right'},playerTrophyRow:{minHeight:38,flexDirection:'row',alignItems:'center',borderBottomWidth:1,borderBottomColor:'rgba(255,255,255,.06)'},playerTrophyIcon:{width:26,height:26,borderRadius:13,backgroundColor:'rgba(241,185,79,.13)',alignItems:'center',justifyContent:'center',marginRight:8},playerTrophyIconText:{color:'#f1b94f',fontSize:9},playerTrophyText:{flex:1,color:'#fff',fontSize:6.8,fontWeight:'600'},
