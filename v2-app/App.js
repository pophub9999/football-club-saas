...
const s=StyleSheet.create({
 root:{flex:1,backgroundColor:Platform.OS==='web'?'#00142c':'#5e8fb0',alignItems:'center',justifyContent:'center',overflow:'hidden'},background:{width:'100%',height:'100%',opacity:Platform.OS==='web'?1:.98},mobileLightWash:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(220,240,250,.28)'},
 card:{width:'100%',backgroundColor:Platform.OS==='web'?'rgba(8,43,72,.90)':'rgba(51,101,136,.88)',borderWidth:1,borderColor:'rgba(120,164,197,.34)',borderRadius:14,paddingHorizontal:13,paddingVertical:9},
