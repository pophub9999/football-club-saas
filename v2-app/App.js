...
const s=StyleSheet.create({
 ...
 newsSection:{marginTop:12},newsHeader:{flexDirection:'row',justifyContent:'space-between',marginBottom:7},newsHeading:{color:'#fff',fontSize:fs(8.5),letterSpacing:.65},newsMore:{color:'#f1b94f',fontSize:fs(6.5)},newsCard:{minHeight:58,marginBottom:6,borderRadius:10,backgroundColor:Platform.OS==='web'?'rgba(8,43,72,.84)':'rgba(24,66,99,.84)',borderWidth:1,borderColor:'rgba(120,164,197,.25)',flexDirection:'row',alignItems:'center',overflow:'hidden'},newsAccent:{width:3,alignSelf:'stretch',backgroundColor:'#a91f42'},newsThumb:{width:74,height:58,backgroundColor:'rgba(255,255,255,.06)'},newsThumbFallback:{alignItems:'center',justifyContent:'center'},newsThumbLogo:{width:34,height:40},newsBody:{flex:1,paddingHorizontal:9,paddingVertical:7},newsMeta:{color:'#f1b94f',fontSize:fs(5.8),letterSpacing:.45,marginBottom:3},newsTitle:{color:'#fff',fontSize:fs(8),lineHeight:fs(11)},newsArrow:{color:'#9eb6c9',fontSize:fs(18),paddingHorizontal:8},
