...
void main() {
  const branding = ClubBranding(name: 'Clube Principal', shortName: 'Clube Principal', slogan: 'Juntos somos mais fortes', primaryColor: Color(0xFF008C45), secondaryColor: Color(0xFF005B2A), accentColor: Color(0xFFD7E83F), backgroundColor: Color(0xFF07110D), surfaceColor: Color(0xFF102019));
...
class FootballClubApp extends StatefulWidget {
  ...
  @override State<FootballClubApp> createState() => _FootballClubAppState();
}
...
class _SplashScreen extends StatelessWidget {
  ...
  final ClubBranding branding;
  @override Widget build(BuildContext context) => Scaffold(backgroundColor: branding.backgroundColor, body: Center(child: Column(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.shield, color: branding.primaryColor, size: 64), const SizedBox(height: 18), Text(branding.name, style: TextStyle(color: branding.textColor, fontSize: 22, fontWeight: FontWeight.w900)), const SizedBox(height: 24), SizedBox(width: 22, height: 22, child: CircularProgressIndicator(strokeWidth: 2, color: branding.primaryColor))])));
}
