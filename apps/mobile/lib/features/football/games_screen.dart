...
class _GamesScreenState extends State<GamesScreen> {
  ...
  void _openMatchCentre(FixtureSummary fixture) {
    Navigator.of(context).push(
      MaterialPageRoute(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    icon: Icon(Icons.emoji_events_outlined, color: b.primaryColor),
                  ),
                ],
              ),
            ),
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
              child: Row(
                children: [
                  Expanded(
                    child: Text('Próximos jogos do clube', style: TextStyle(color: b.mutedTextColor)),
                  ),
                  TextButton.icon(
                    onPressed: _openStandings,
  ...
  Widget _message(String text, String action, VoidCallback onPressed) {
    final b = widget.branding;
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.sports_soccer_outlined, size: 48, color: b.mutedTextColor),
  ...
  Widget _fixtureCard(FixtureSummary fixture, ClubBranding b) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: b.primaryColor.withValues(alpha: .12)),
      ),
      child: Column(
        children: [
          Row(
          ...
          if (fixture.venueName != null) ...[
            ...
            Row(
              ...
              children: [
                Icon(Icons.location_on_outlined, size: 15, color: b.mutedTextColor),
            ...
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  onPressed: () => _openMatchCentre(fixture),
              ...
              IconButton.filled(
                onPressed: () => _openMatchday(fixture),
                tooltip: 'Dia de jogo',
  ...
  Widget _team(String name, String? logoUrl, ClubBranding b, Alignment alignment) {
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: logoUrl == null
              ? Icon(Icons.shield_outlined, color: b.primaryColor)
              : ClipOval(
                  child: Image.network(
                    logoUrl,
                    fit: BoxFit.contain,
                    errorBuilder: (_, __, ___) => Icon(Icons.shield_outlined, color: b.primaryColor),
                  ),
                ),
        ),
        ...
        Text(
          ...
          style: TextStyle(color: b.textColor, fontWeight: FontWeight.w700, fontSize: 13),
        ),
      ],
    );
  }
