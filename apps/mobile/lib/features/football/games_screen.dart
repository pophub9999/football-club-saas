...
class _GamesScreenState extends State<GamesScreen> {
  ...
  Widget _message(String text, String action, VoidCallback onPressed) => Center(child: Padding(padding: const EdgeInsets.all(28), child: Column(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.sports_soccer_outlined, size: 48, color: widget.branding.mutedTextColor), const SizedBox(height: 14), Text(text, textAlign: TextAlign.center, style: TextStyle(color: widget.branding.textColor, fontWeight: FontWeight.w700)), const SizedBox(height: 14), OutlinedButton(onPressed: onPressed, child: Text(action))])));
