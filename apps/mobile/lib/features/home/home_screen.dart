      ...
      children: [
        Container(
          ...
          child: logoUrl == null
              ...
              : ClipOval(child: Image.network(logoUrl, fit: BoxFit.contain, errorBuilder: (_, __, ___) => Icon(Icons.shield, color: b.primaryColor))),
        ),
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (_) {
            return TicketsScreen(branding: b, api: widget.api, accessToken: widget.accessToken);
          }));
        },
        child: Padding(
