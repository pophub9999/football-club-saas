    ...
    return RefreshIndicator(
      ...
      child: CustomScrollView(
        ...
        slivers: [
          ...
          SliverPadding(padding: const EdgeInsets.fromLTRB(20, 14, 20, 0), sliver: SliverToBoxAdapter(child: _ticketsButton())),
  ...
  Widget _nextMatch() {
    ...
    if (match == null) {
      return Container(
        ...
        child: const Center(child: Text('Ainda não existem próximos jogos', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700))),
      );
    }
      ...
      child: Column(
        children: [
          ...
          if (match['venueName'] != null) ...[
            const SizedBox(height: 14),
            Text(match['venueName'] as String, style: const TextStyle(color: Colors.white70, fontSize: 12)),
          ],
        ],
      ),
    );
    ...
    return Column(
      children: [
        Container(
          ...
          child: logoUrl == null ? Icon(Icons.shield, color: b.primaryColor, size: 30) : ClipOval(child: Image.network(logoUrl, fit: BoxFit.contain, errorBuilder: (_, __, ___) => Icon(Icons.shield, color: b.primaryColor))),
        ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(label, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: b.textColor, fontWeight: FontWeight.w700)), const SizedBox(height: 5), Text('$outstanding € · $statusLabel', style: TextStyle(color: b.mutedTextColor, fontSize: 13))])),
        ],
      ),
    );
  }
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Os meus bilhetes', style: TextStyle(color: b.textColor, fontWeight: FontWeight.w800)), const SizedBox(height: 3), Text('Acede aos teus bilhetes digitais e QR de entrada', style: TextStyle(color: b.mutedTextColor, fontSize: 12))])),
