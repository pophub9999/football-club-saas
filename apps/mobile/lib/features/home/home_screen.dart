...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _content(BuildContext context) {
    ...
    if (data == null) {
      if (error != null) return Center(child: Padding(padding: const EdgeInsets.all(28), child: Column(mainAxisSize: MainAxisSize.min, children: [
  ...
  Widget _team(String name, String? logoUrl) => Column(children: [
    Container(width: 58, height: 58, decoration: const BoxDecoration(color: Colors.white, shape: BoxShape.circle), child: logoUrl == null ? Icon(Icons.shield, color: b.primaryColor, size: 30) : ClipOval(child: Image.network(logoUrl, fit: BoxFit.contain, errorBuilder: (_, __, ___) => Icon(Icons.shield, color: b.primaryColor)))),
  ...
  Widget _ticketsButton(BuildContext context) => Material(
